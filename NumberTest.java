class NumberTest{
	public static void main(String[] args){
		...
		System.out.println('2' + '3'); 	//101	5
		System.out.println("2" + "3"); //23
		System.out.println((char)('A' + 32)); //97 -> a, Cast연산(강제형변환)
		
		System.out.println('2' + '3'); //문자를 숫자로 변환
		...
		System.out.println("25 / 6 = " + String.format("%.2f",Double.parseDouble("25.0") / Integer.parseInt("6"))); //4.17
